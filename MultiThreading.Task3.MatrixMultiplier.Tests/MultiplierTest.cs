...
public class UnitTest1
{
    ...
    public class MultiplierTest
    {
        ...
        {
            var matricesMultiplierWatch = Stopwatch.StartNew();
            TestMatrix3On3(new MatricesMultiplier());
            matricesMultiplierWatch.Stop();

            var matricesMultiplierParallelWatch = Stopwatch.StartNew();
            TestMatrix3On3(new MatricesMultiplier());
            matricesMultiplierParallelWatch.Stop();

            var matricesMultiplierElapsedMs = matricesMultiplierWatch.ElapsedMilliseconds;
            var matricesMultiplierParallelMs = matricesMultiplierParallelWatch.ElapsedMilliseconds;
        }
